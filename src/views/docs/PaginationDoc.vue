...
<template>
  <div class="space-y-12">
    <section>
      <h1 class="text-4xl font-bold mb-4">Pagination 分页</h1>
      <p class="text-neu-text/80 text-lg">
        带有新拟态物理质感的分页组件，当前激活的页码呈现内凹的按压状态。
      </p>
    </section>
    ...
    <section>
      ...
      <NeuCard class="flex flex-col gap-8 p-12 bg-[var(--bg-color)] max-w-4xl">
        <div>
          <h3 class="font-bold text-sm mb-4 text-neu-text/60">常规数量 (少于 7 页)</h3>
        ...
        <div>
          <h3 class="font-bold text-sm mb-4 text-neu-text/60">较多数量 (带省略号) 当前页: {{ currentPage2 }}</h3>
